...
<div class="mj-container" style="background-color:#FFFFFF;"><!--[if mso | IE]>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="background:#49a6e8;font-size:0px;width:100%;"
           border="0">
        <tbody>
        <tr>
            <td>
                                        ...
                                        <tr>
                                            <td style="word-wrap:break-word;font-size:0px;padding:0px 20px 0px 20px;"
                                                ...
                                                <div style="cursor:auto;color:#FFFFFF;font-family:Lato, Tahoma, sans-serif;font-size:14px;line-height:22px;text-align:center;">
                                                    <h1 style="font-family: &apos;Cabin&apos;, sans-serif; color: #FFFFFF; font-size: 32px; line-height: 100%;">
                                                        ZackTheTeacher</h1>
                                                    <p>Подтвердите регистрацию перейдя по ссылке: </p>
                                                    <p><a href="{{ ($url = route('client.students.showJoinForm', ['token' => $invite->code])) }}">{{ $url }}</a></p>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
